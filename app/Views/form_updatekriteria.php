          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active">Form Update Kriteria</li>
              </ol>
            </div>
          </div>
        </div>
            ...
            <div class="col-md-6">
              ...
              <div class="card card-primary">
                <div class="card-header">
                  <h3 class="card-title">Form Update Kriteria</h3>
                </div>
                <!-- form start -->
                <form action="<?= base_url('/home/updatedatakriteria/' . $kriteria->id) ?>" method="POST">
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" step="0.01" class="form-control" id="nilai_kriteria" name="nilai_kriteria"
                        value="<?= $kriteria->nilai_kriteria ?>" required>
                    </div>
                    <div class="form-group">
